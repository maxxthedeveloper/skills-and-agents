...
5. **Context Awareness**: Consider the specific project context — read the repo's stack (framework, state, auth, styling) before recommending anything
